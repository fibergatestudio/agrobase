            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row required">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">Телефон (основной)</label>
                        ...
                        <div class="form-group row required">
                            <label for="messenger" class="col-md-4 col-form-label text-md-right">Телефон (мессенджер)</label>
