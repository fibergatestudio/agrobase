                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <!-- NEW -->
                            ...
                            <div class="form-group row required">
                                <label for="country" class="col-md-2 col-form-label text-md-right">Страна</label>
                                ...
                                <label for="city" class="col-md-2 col-form-label text-md-right">Город</label>
                        ...
                        <div class="form-group row required">
                            <label for="reg_code" class="col-md-2 col-form-label text-md-right">Регистрационный код</label>

                            <div class="col-md-4">
                                <input id="reg_code" type="text" class="form-control " name="reg_code" value="" required autocomplete="reg_code">
                            </div>

                            <label for="address" class="col-md-2 col-form-label text-md-right">Адрес</label>
                        ...
                        <div class="form-group row">
                            <label for="website" class="col-md-2 col-form-label text-md-right">Сайт</label>

                            <div class="col-md-4">
                                <input id="website" type="text" class="form-control " name="website" value="" autocomplete="website">
                            </div>

                            <label for="contact_name" class="col-md-2 col-form-label text-md-right">Контактное лицо</label>
                        ...
                        <div class="form-group row required">
                            ...
                            <select class="form-control col-md-4" name="activity">
