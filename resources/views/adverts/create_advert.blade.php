    ...
    @endif
            ...
            <div class="declaration-main">
                ...
                <div class="declaration-wrapper">
                    <h3 class="declaration-title">Добавить Обьявление</h3>
                    <div class="declaration-block_top">
                        <div class="declaration-string">
                            <label class="top-string_label label-typical">Действие</label>
                            <div class="label-arrow-wrapper">
                            <select id="action" class="top-string_select select-typical" name="action" value="">
                        ...
                        <div class="declaration-string">
                            <label class="top-string_label label-typical">Товар</label>
                            <div class="label-arrow-wrapper">
                            <!-- <select class="top-string_select select-typical" name="select">
                                <option value="">Выберите</option>
                                <option value="">Опция 2</option>
                                <option value="">Опция 3</option>
                            </select> -->
                            <div class="col-md-6">
                                <select id="prod" class="top-string_select select-typical" name="prod" value="" required>
                                    <option value="">Выберите</option>
                                ...
                                <!-- Зерновые -->
                                <select id="prod_zern" class="top-string_select select-typical" name="prod_zern" value="">
                                ...
                                <!-- -->
                                <!-- Масличные -->
                                <select id="prod_masl" class="top-string_select select-typical" name="prod_masl" value="">
                                    <option>Выберите</option>
                                ...
                                <!-- -->
                                <!-- Бобовые -->
                                <select id="prod_bob" class="top-string_select select-typical" name="prod_bob" value="">
                                    <option>Выберите</option>
                                ...
                                <!-- НИШЕВЫЕ КУЛЬТУРЫ -->
                                <select id="prod_cult" class="top-string_select select-typical" name="prod_cult" value="">
                                    <option>Выберите</option>
                                ...
                                <select id="prod_pererab" class="top-string_select select-typical" name="prod_pererab" value="">
                                    <option>Выберите</option>
                                    ...
                                    <!-- Мука -->
                                    <select id="prod_muka" class="top-string_select select-typical" name="prod_muka" value="">
                                        <option>Выберите</option>
                                    ...
                                    <!-- Отруби -->
                                    <select id="prod_otrub" class="top-string_select select-typical" name="prod_otrub" value="">
                                        <option>Выберите</option>
                                    ...
                                    <!-- Жмых --> 
                                    <select id="prod_jmih" class="top-string_select select-typical" name="prod_jmih" value="">
                                        <option>Выберите</option>
                                    ...
                                    <!-- Шрот -->
                                    <select id="prod_shrot" class="top-string_select select-typical" name="prod_shrot" value="">
                                        <option>Выберите</option>
                                        <option value="Подсолнечный">Подсолнечный</option>
                                        <option value="Соевый">Соевый</option>
                                        <option value="Рапсовый">Рапсовый</option>
                                    ...
                                    <!-- Крупа --> 
                                    <select id="prod_krupa" class="top-string_select select-typical" name="prod_krupa" value="">
                                        <option>Выберите</option>
                                        <option value="Пшеничная">Пшеничная</option>
                                    ...
                                    <!-- Масло --> 
                                    <select id="prod_maslo" class="top-string_select select-typical" name="prod_maslo" value="">
                                        <option>Выберите</option>
                                ...
                                <!-- Топливо Древесное --> 
                                <select id="prod_drev" class="top-string_select select-typical" name="prod_drev" value="">
                                    <option>Выберите</option>
                        ...
                        <div class="declaration-string">
                            <label class="top-string_label label-typical">Место поставки</label>
                            <div class="label-arrow-wrapper">
                            <!-- <select  class="top-string_select select-typical" name="select">
                                <option value="">Место поставки</option>
                                <option value="">Опция 2</option>
                                <option value="">Опция 3</option>
                            </select> -->
                            <div class="col-md-6">
                                <input id="sale_place" type="text" class="middle-string_select select-typical middle-input" name="sale_place" value="" placeholder="Место поставки" required>
                            </div>
                        </div>
                        </div>
                        <div class="declaration-string">
                            <label class="top-string_label label-typical">Вид поставки</label>
                            <div class="label-arrow-wrapper">
                            <!-- <select  class="top-string_select select-typical" name="select" id="">
                                <option value="">Выберите действие</option>
                                <option value="">Опция 2</option>
                                <option value="">Опция 3</option>
                            </select> -->
                            <select id="delivery" class="top-string_select select-typical" name="delivery" required>
                                    <option value="">Выберите действие</option>
                    ...
                    <div class="declaration-block_middle">
                        <div class="declaration-string">
                            <label class="middle-string_label label-typical">Цена (за тонну)</label>
                            <div class="label-arrow-wrapper_bottom">
                            <!-- <select class="middle-string_select select-typical" name="select">
                                <option value="">Цена</option>
                                <option value="">Опция 2</option>
                                <option value="">Опция 3</option>
                            </select> -->
                            <div class="col-md-6">
                                <input id="price" type="number" class="middle-string_select select-typical middle-input" name="price" value="" placeholder="Цена" required>
                            </div>
                        </div>
                        </div>
                        <div class="declaration-string">
                            <label class="middle-string_label label-typical">Валюта</label>
                            <div class="label-arrow-wrapper_bottom">
                            <!-- <select class="middle-string_select select-typical" name="select">
                            ...
                            <select id="currency" class="middle-string_select select-typical" name="currency" value="">
                        ...
                        <div class="declaration-string">
                            <label class="middle-string_label label-typical">Количество (тонн)</label>
                            <input id="amount" type="number" class="middle-string_select select-typical middle-input" name="amount" value="" placeholder="Количество" required>
                              
                        </div>
                        <div class="declaration-string">
                            <label class="middle-string_label label-typical label-startposition">Описание товара</label>
                              <textarea id="prod_descr" type="text" class="middle-string_textarea select-typical" name="prod_descr" value="" placeholder="Описание товара" required></textarea>
                        </div>
                    </div>
                    <div class="declaration-block_bottom">
                        <div class="declaration-string">
                        <label class="bottom-string_label label-typical">Фото (товара)</label>
                       
                        <!-- <button class="bottom-button" id="product-foto" >Выбрать файл</button> -->
                        <input id="prod_photo" type="file" class="bottom-button" name="prod_photo[]" value="" placeholder="Фото" multiple>
                        <!-- <label class="bottom-string_label label-typical" for="product-foto">Файл не выбран</label> -->
                        </div> 
                    </div>
                 ...
                 <button class="tables-btn" >Добавить</button>
                </form>
            </div>
